...
概略设计文档等，过程文档在 <a target="_blank" href="//best-practice.github.io/www/">best-practice/www</a> 博客公开。
...
但各阶段不指定终止日期，目标完成（或中间取消了）阶段性工作自然结束。所有活动都在 <a target="_blank" href="//best-practice.github.io/www/?opendoc=%2Fwww%2F%24%24netlog%2FREADME.blog%2F">Todo list</a> 列出，外部人员主要通过查看这份列表了解活动进展情况。项目成员则主要借助即时通信群进行日常沟通。

先确定首个路标规划，探索最佳实践 之 路标规划一：在 github 上建立一套博客系统。

工作目标：建立博客主页，分类展示已发布的博客文章，提供在线编辑器，还支持在 Windows 客户端离线编写博客，用 git
命令行发布到 github.io 后，可通过访问 `http://<username>.github.io/blog/` 在线浏览指定用户的博客主页。
博客主页提供如下功能：

 1. 查看作者最近发布的文章
 2. 每篇文章都可点赞，允许评论
 3. 如果访问者已开通 pinp.me 帐号，他还可收藏 github 上别人发布的拼文
 4. 提供文档聚合功能，发布博客时可指定文档的 keywords 及所属话题，访问博客时，相关文章自动被推荐。
 5. 支持话题、子话题定义，同一话题的博客（分散在多个作者名下）可拎到一个列表集中供查阅。

该路标规划下的第一阶段迭代，计划支持博客的在线编辑与离线编辑功能。
第二阶段的迭代，则为博客再增加动态服务功能（点赞、评论等）。关于 “在 github 上建立一套博客系统” 的开发目标、设计思路等介绍，
<a target="_blank" href="http://best-practice.github.io/www/$$doc/buid-blog-system-on-github/">请参考这一篇：在 github 上构建博客系统</a>。

当 github 上的博客系统建起来后，我们将开启其它路标规划，比如，探索最佳实践 之 路标规划二：
试验 react/nodeJS/docker 最简系统。（注：此项暂定）
...
1. 学习围观    
如果觉得我们探索对您有参考价值，不妨在浏览器先收藏本 Blog 主页， <a target="_blank" href="//best-practice.github.io/www/">best-practice/www</a>，在我们实现 PINP 博客对微信对接之前，需要手工访问这个主页。对接后，新文章或活动新进展的信息，会推送到微信，到时我再邀请大家关注一个微信账号。

2. 准备在 github 上写博客  
请按 <a target="_blank" href="https://github.com/pinp/software">pinp/software</a> 项目主页上的介绍，3步操作就能搭建出你自己的个人博客。如果你的博客与 “探索前后端一体化开发” 紧密相关，不妨联系我，我把你的博客库也嵌入到本专题中来。

3. 对所探索的主题感兴趣，希望参与进来  
如果希望参与本专题活动，承担部分设计、编码、撰稿等工作，请用微信联系我。
